...
<body>
    ...
    <div class="flex items-center justify-center h-screen bg-gray-200" id="register">
        <div class="bg-white p-6 rounded-lg shadow-lg mt-20 w-1/2">
        ...
        navbarLinks.foreach((li) => {
          li.addEventListener("click", (e) => {
            ...
            const link = li.querySelector("a");
              const targerId = link.getAttribute("href").substring(1);
              console.log(targerId);
              const targetSection = document.getElementById(targerId);
